...
Volt Dashboard is a free and open source **[Bootstrap 5](https://appseed.us/admin-dashboards/django-dashboard-volt)** Admin Dashboard featuring over 100 components, 11 example pages and 3 plugins with Vanilla JS. There are more than 100 free Bootstrap 5 components included some of them being buttons, alerts, modals, datepickers and so on.
